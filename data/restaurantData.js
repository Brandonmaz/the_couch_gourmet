const restaurants =[
  ...
  },
  {
    ...
    about: "One of a handful of cooks who have remained at the top of global fine dining for decades, Alain Passard needs little introduction. He has retained three Michelin stars at Arpège for more than two decades during times of great personal and culinary change, and in 2019 he was the recipient of the Chefs’ Choice Award, sponsored by Estrella Damm, at The World’s 50 Best Restaurants awards in Singapore. Vegetables, in short. Passard famously in 2001 announced that Arpège – until then a meat institution – was turning vegetarian, and although meat has since returned to the restaurant in smaller quantities, vegetables still take the main stage. They arrive daily from Passard’s own farms and appear on diners’ plates soon after.",
    posts:[]
  },
  {
    username: "Maido",
    ...
    about: "When Peru meets Japan on the plate, Nikkei is born – and chef Mitsuharu ‘Micha’ Tsumura is the Nikkei king. This translates to a welcoming spot where fresh fish and citrus-packed sauces reign supreme. Little wonder it was voted The Best Restaurant in Latin America in both 2017 and 2018. Tsumura’s Nikkei Experience menu is a journey through Peruvian-Japanese fusion cuisine, with an emphasis on seafood. There is succulent cod marinated in miso with crispy nuts, nigiri sushi, sea urchin rice, the now-legendary 50-hour-cooked beef short rib and even tofu cheesecake ice cream. Everything sings with flavour, zing and the natural bright colours that come from Peru’s produce. There’s also a separate sushi counter and menu for regular or business diners.",
    posts:[]
  },
  {
    username: "Septime",
  ...
  },
  {
    ...
    about: " Twin brothers Mathias and Thomas Sühring meld flavours, techniques and experiences accumulated in their native Germany as well as the Netherlands, Italy and Thailand, under one modish roof. The result is a sophisticated – and at times playful – seasonal haute cuisine menu with strong German identity. European influence is welcomed in a city known for racy spices, and strong plates on the three-chapter menu include Frankfurter Grüne Soße and smoked eel;  a one-bite chicken salad; a currywurst street food tribute served in a box complete with wooden fork; and spaetzle egg noodles topped with Alba truffles, all inciting plenty of German culinary nostalgia.",
    posts:[]
  },
  {
    username: "De Librije",
